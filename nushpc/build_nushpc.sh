...
case $compiler in
  ...
  #      addpath PATH /usr/bin
	addpath PATH /app1/centos6.3/gnu/gcc-4.8.2/bin
   #     addpath PATH /cm/local/apps/gcc/5.1.0/bin
#      addpath LD_LIBRARY_PATH /usr/lib/gcc/x86_64-linux-gnu/5.4.0
#	addpath LD_LIBRARY_PATH /usr/lib/gcc/x86_64-redhat-linux/4.4.4
 #       addpath LD_LIBRARY_PATH /cm/local/apps/gcc/5.1.0/lib/gcc/x86_64-unkown-linux-gnu
	addpath LD_LIBRARY_PATH /app1/centos6.3/gnu/gcc-4.8.2/lib/gcc/x86_64-redhat-linux/4.8.2
...
#----------------------
#autoconf
#addpath PATH /home/users/nus/e0022672/usr/local/bin
addpath PATH /app1/centos6.3/gnu/apps/R-3.0.2/bin
addpath LD_LIBRARY_PATH /app1/centos6.3/gnu/apps/R-3.0.2/lib64/R/lib
...
#    export MPILIBS_ADDITIONAL="-L/opt/mpich2-1.4.1-gcc-4.6.2/lib -lfmpich -lmpich -lmpl"
    ...
    addpath PATH /home/svu/e0022672/download/mpich3/bin
    export MPI_INCLUDE=/home/svu/e0022672/download/mpich3/include
    export MPILIBS_ADDITIONAL="-L/home/svu/e0022672/download/mpich3/lib -lfmpich -lmpich -lmpl"
#it is better to use the absolute directory here!
    # export MPILIBS_ADDITIONAL=" "
    # export MPIFC=/opt/mpich2-1.4.1-gcc-4.6.2/bin/mpif90  
    export MPIFC=/home/svu/e0022672/download/mpich3/bin/mpif90
else
    # Intel compilers
...
export NETCDFROOT="/home/svu/e0022672/download/netcdf_4.4"
