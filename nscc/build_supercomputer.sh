...
#    export MPILIBS_ADDITIONAL="-L/opt/mpich2-1.4.1-gcc-4.6.2/lib -lfmpich -lmpich -lmpl"
    ...
    addpath PATH /home/users/nus/e0022672/Downloads/libraries/mpich3/bin
    export MPI_INCLUDE=/home/users/nus/e0022672/Downloads/libraries/mpich3/include
    export MPILIBS_ADDITIONAL="-L/home/users/nus/e0022672/Downloads/libraries/mpich3/lib -lfmpich -lmpich -lmpl"
#it is better to use the absolute directory here!
    ...
    export MPIFC=/home/users/nus/e0022672/Downloads/libraries/mpich3/bin/mpif90
else
    # Intel compilers
...
export NETCDFROOT="/home/users/nus/e0022672/Downloads/libraries/netcdf_4.4"
